...
\begin{definition}[Volume]
    The volume of a set of vertex $S$ is the sum of degree in the graph induced by $S$ and the neighbour vertexes. Equivalently, it is twice the number of edges in the induced graph.
    \[
...
\begin{definition}[Good definition of conductance of a cut]
    \[
        \Phi(S) \defeq \frac{\card{E(S,\overline{S})}}{\min\left(\opname{vol} S,\opname{vol} \overline{S}\right)}
    \]
\end{definition}
...
\begin{definition}
    \[
        h(S) \defeq \frac{\card{E(S,\overline{S})}}{(\opname{vol} S)(\opname{vol} \overline{S})} \opname{vol} G
    \]
\end{definition}
...
\[
    \frac{1}{2} \leqslant \frac{\opname{vol} \overline{S}}{\opname{vol} G} \leqslant 1
\]
...
\begin{definition}
    \[
        \begin{aligned}
            ...
            &=\min\limits_S \frac{\card{E(S,\overline{S})}}{(\opname{vol} S)(\opname{vol} \overline{S})} \opname{vol} G
        \end{aligned}
    \]
\end{definition}
...
\begin{Huge}
    \textcolor{red}{Je comprends pas cette formule ni la proposition en dessous, mais j'ai du mal à croire cette formule sans justification.}
\end{Huge}
...
\begin{Huge}
    \textcolor{red}{Ca, c'est dégueulasse, mais je sais pas quoi en faire.}
\end{Huge}
...
\begin{Huge}
    \textcolor{red}{Expliquer ce que sont les $x_i$}
\end{Huge}
...
\[
    \begin{aligned}
        \underset{(i,j) \la \mu\times\mu}{\EE} (x_i-x_j)^2 &= \underset{(i,j)\la\mu\times\mu}{\EE} ({x_i}^2+{x_j}^2-2x_ix_j)\\
