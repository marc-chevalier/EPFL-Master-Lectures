...
\usepackage{wasysym}
\usepackage{qtree}
\usepackage[singlefile, psfrag]{graphviz}
...
\newboxedtheorem[boxcolor=black, background=black!0, titlebackground=black!20,titleboxcolor = black]{exercise}{Exercise}{ExC}
